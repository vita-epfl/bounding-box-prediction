...
class args():
    def __init__(self):
        self.jaad_dataset = '../../../../data/haziq-data/jaad/annotations'
        self.dtype        = 'train'
        self.from_file    = True
        self.file         = '/data/smail-data/jaad_train_16_16_n.csv'
        self.val_file     = '/data/smail-data/jaad_val_16_16_n.csv'
...
train, val, test = DataLoader.data_loader(args)
...
for epoch in range(args.n_epochs):
    ...
    print('e:', epoch+1, '| ts: %.4f'% avg_epoch_train_s_loss, '| tc: %.4f'% avg_epoch_train_c_loss,
